...
def user_profile(username):
    ...
    # Getting the posts only from the current user
    # Filtered using the username of the current user
    posts = Post.query\
...
def signup():
    ...
    if form.validate_on_submit():
        ...
        # Making a user with the given data in the form
...
@login_required
def profile():
    # Storing the pfp(s) in the static directory
